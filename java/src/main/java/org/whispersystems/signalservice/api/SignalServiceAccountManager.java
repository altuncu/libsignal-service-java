...
public class SignalServiceAccountManager {
  ...
  public SignalServiceAccountManager(String gaiaHubURL, SignalServiceConfiguration configuration,
                                     String password, String userAgent) throws IOException {

    URL url = new URL(gaiaHubURL);
    ...
    StaticCredentialsProvider credentialsProvider = new StaticCredentialsProvider(number, password, null);
